    ...
    <footer className="bg-[#1A1A1A] text-[#F5F5F5] py-12">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="mb-2">
                Phone: <a href="tel:07507008009" className="text-[#DFFF00] hover:underline">075070 08009</a>
              </p>
              <h4 className="font-semibold mt-4 mb-2">Opening Hours:</h4>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} MultiFit Aundh. All rights reserved.
          </div>
        </footer>
  );
}
