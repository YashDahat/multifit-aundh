      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mb-2">
            <span className="font-medium">Address:</span> Multifit Aundh , D.P. Road Medipoint Hospital Road, opp. to Indian Bank, Aundh, Pune, Maharashtra 411067
          </p>
          <p className="text-sm mb-2">
            <span className="font-medium">Phone:</span> 075070 08009
          </p>
          <p className="text-sm">
            <span className="font-medium">Opening Hours:</span> Please contact us for current hours.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative w-full h-64 rounded-lg overflow-hidden">
            <iframe
              src="https://maps.google.com/maps?q=18.562876,73.783691&z=15&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
