  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1A1A1A]">
      <div className="w-full max-w-md bg-[#333333] rounded-lg shadow-xl p-8">
        <h2 className="text-3xl font-bold text-[#F5F5F5] text-center mb-6">Admin Login for MultiFit Aundh</h2>
        <p className="text-[#F5F5F5] text-opacity-80 text-center mb-8">Access the MultiFit Aundh management portal.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {loading && <p className="text-center mt-4 text-blue-400">Logging in...</p>}
